...
{
    /**
     * @Route("/oauth/authorize", name="_authorize_validate")
     * @Method({"GET"})
     * @Template("KSServerBundle:Authorize:authorize.html.twig")
     */
    ...
    /**
     * @Route("/oauth/authorize", name="_authorize_handle")
     * @Method({"POST"})
     */
    public function handleAuthorizeAction()
    {
        ...
        return $server->handleAuthorizeRequest($this->get('oauth2.request'), $this->get('oauth2.response'), true,$this->get('oauth2.request')->query->get('user_id'));
    }
}
