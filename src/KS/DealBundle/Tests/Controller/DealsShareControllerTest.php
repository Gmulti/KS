...
class DealsShareControllerTest extends GeneralController
{
    ...
    public function testPostShareDeal(){
        ...
        if (self::$idDeal !== null) {
		    ...
		    $crawler = $client->request('POST', 
		        '/api/v1/deals/' . self::$idDeal . '/shares.json',
		        array(),
		        array(),
		        self::$headers
		    );
		    ...
		    if ($response->getStatusCode() == 404) {
		    	 $this->assertEquals($msg['error'], 'already_share');
		    }
		    else{
